    ...
    <Popover className="relative flex">
      {({ open }: { open: boolean }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute bottom-0 border border-neutral-200 dark:border-neutral-700 transform translate-x-8 rounded-md shadow-lg">
              <div className="w-52 bg-white dark:bg-black flex flex-col p-2 rounded-lg">
                <SidebarSubButton

    ...
    <header className="bg-neutral-50 dark:bg-black border-b dark:border-neutral-700 transition-colors ease-in duration-200">
      <div className="container flex flex-col p-6">
        ...
        <div className="flex flex-row space-x-6">
          <div className="w-full sm:w-fit flex flex-row justify-between items-center space-x-2 px-4 py-2 md:p-4 bg-white dark:bg-black border border-neutral-300 dark:border-neutral-700 rounded-lg shadow transition-colors ease-in duration-200">
